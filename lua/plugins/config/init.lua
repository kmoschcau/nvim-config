...
xpcall(require, ehandler, "plugins.config.autopairs")
...
xpcall(require, ehandler, "plugins.config.fidget")
xpcall(require, ehandler, "plugins.config.gitsigns")
xpcall(require, ehandler, "plugins.config.highlight-colors")
xpcall(require, ehandler, "plugins.config.illuminate")
xpcall(require, ehandler, "plugins.config.lsp")
xpcall(require, ehandler, "plugins.config.lualine")
xpcall(require, ehandler, "plugins.config.luasnip")
