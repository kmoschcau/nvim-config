...
local pkgs_by_ft = {
  ...
  javascript = { "dprint", "oxfmt", "prettier" },
  javascriptreact = { "dprint", "emmet-language-server", "oxfmt", "prettier" },
  jq = { "jq" },
  json = { "dprint", "jsonlint", "oxfmt", "prettier" },
  json5 = { "prettier" },
  ["json.cloudformation"] = { "cfn-lint" },
  jsonc = { "dprint", "oxfmt", "prettier" },
  less = { "dprint", "oxfmt", "prettier" },
  kotlin = { "ktlint" },
  lua = { "selene", "stylua" },
  markdown = { "oxfmt", "proselint" },
  ocaml = { "ocamlformat" },
  razor = { "emmet-language-server", "roslyn" },
  sass = { "dprint", "oxfmt", "prettier" },
  scss = { "dprint", "oxfmt", "prettier" },
  ...
  toml = { "oxfmt" },
  typescript = { "dprint", "oxfmt", "prettier" },
  typescriptreact = { "dprint", "emmet-language-server", "oxfmt", "prettier" },
  vue = {
    "dprint",
    "emmet-language-server",
    "markuplint",
  ...
  yaml = { "dprint", "yamllint", "oxfmt", "prettier" },
